...
function grabShortode($shortcode_class)
{
    ...
    //return $shortcode_name;
    //do_action('currentShortcodeProcess', $shortcode_name);
}

global $shortcode_name;
